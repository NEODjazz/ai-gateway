...
func TestPostgresBudgetReservationsAreAtomicAndLifecycleAware(t *testing.T) {
	...
	pricingReserve.InputTokens, pricingReserve.OutputTokens, pricingReserve.InputCharacters, pricingReserve.InputPages, pricingReserve.SearchRequests = 100, 200, 1000, 3, 5
	...
	pricingReserve.Cost = pricingCost(pricingReserve.InputTokens, pricingReserve.OutputTokens, pricingReserve.InputCharacters, pricingReserve.InputPages, pricingReserve.SearchRequests, PricingSnapshot{InputCostPer1M: 1, OutputCostPer1M: 2, SearchCostPer1K: 10, CharacterCostPer1M: 15, PageCostPer1K: 100})
	...
	pricingCommit.InputTokens, pricingCommit.OutputTokens, pricingCommit.InputCharacters, pricingCommit.InputPages, pricingCommit.SearchRequests = 50, 50, 500, 2, 2
	...
	pricingCommit.Cost = pricingCost(50, 50, 500, 2, 2, PricingSnapshot{InputCostPer1M: 100, OutputCostPer1M: 200, SearchCostPer1K: 1000, CharacterCostPer1M: 1500, PageCostPer1K: 2000})
	if err := checker.Apply(ctx, pricingCommit); err != nil {
		t.Fatal(err)
	}
	expectedPinnedCost := pricingCost(50, 50, 500, 2, 2, PricingSnapshot{InputCostPer1M: 1, OutputCostPer1M: 2, SearchCostPer1K: 10, CharacterCostPer1M: 15, PageCostPer1K: 100})
	if pricingCommit.CatalogVersion != "v1" || pricingCommit.PricingKey != "provider/model@v1" || pricingCommit.SearchCostPer1K != 10 || pricingCommit.CharacterCostPer1M != 15 || pricingCommit.PageCostPer1K != 100 || math.Abs(pricingCommit.Cost-expectedPinnedCost) > 1e-12 {
...
func applyBudgetTestMigration(t *testing.T, ctx context.Context, pool *pgxpool.Pool) {
	t.Helper()
	for _, name := range []string{"004_budgets.sql", "005_pricing_snapshots.sql", "006_management_audit.sql", "007_tag_budgets.sql", "008_organization_budgets.sql", "010_billing_server_tools.sql", "011_billing_characters.sql", "012_billing_pages.sql"} {

...
func TestClickHouseUsageReporterBuildsBoundedReport(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte("{\"kind\":\"total\",\"date\":\"\",\"name\":\"\",\"currency\":\"USD\",\"requests\":2,\"errors\":1,\"input_tokens\":10,\"output_tokens\":5,\"total_tokens\":15,\"input_characters\":4096,\"input_pages\":4,\"input_audio_milliseconds\":90000,\"tool_requests\":3,\"cache_read_input_tokens\":6,\"cache_write_input_tokens\":2,\"search_requests\":2,\"cost\":0.25,\"avg_latency_ms\":12.5}\n" +

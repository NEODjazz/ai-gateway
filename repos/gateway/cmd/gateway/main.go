...
func main() {
	...
	if providerControlStore != nil {
		...
		handler = handler.WithAssistantStore(providerControlStore, gateway.AssistantRuntimeConfig{OwnerQuota: cfg.Assistants.OwnerQuota, ThreadOwnerQuota: cfg.Assistants.ThreadOwnerQuota})

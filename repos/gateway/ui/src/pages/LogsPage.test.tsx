...
describe("LogsPage", () => {
  it("combines request and audit logs in isolated tabs", async () => {
    vi.spyOn(globalThis, "fetch").mockImplementation(async (input) => {
      ...
      if (path.includes("request-logs")) return json({ data: [{ request_id: "req-1", timestamp: "2026-08-28T10:00:00Z", status: "ok", model: "gpt", provider_id: "azure", cache_status: "hit", total_tokens: 10, latency_ms: 12, cost: 0.1, currency: "USD" }] });

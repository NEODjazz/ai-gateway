...
export function DeploymentsPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const params = new URLSearchParams({ search, provider: providerFilter, state: stateFilter, sort, order, limit: "25", offset: String(offset) });
  ...
  }, [client, offset, order, providerFilter, search, sort, stateFilter]);

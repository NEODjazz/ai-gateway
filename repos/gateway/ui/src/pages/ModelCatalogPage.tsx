...
const fields: Field[] = [{ key: "provider", label: "Provider", type: "reference", required: true, reference: { path: "/admin/v1/providers", labelKeys: ["type", "base_url"] } }, { key: "model", label: "Model", required: true }, { key: "capabilities", label: "Capabilities", type: "multi-select", chipOptions: modelCapabilityOptions }, { key: "max_input_tokens", label: "Maximum input tokens", type: "number" }, { key: "max_output_tokens", label: "Maximum output tokens", type: "number" }, { key: "input_cost_per_1m", label: "Input cost / 1M", type: "number" }, { key: "output_cost_per_1m", label: "Output cost / 1M", type: "number" }, { key: "training_cost_per_1m", label: "Training cost / 1M", type: "number" }, { key: "search_cost_per_1k", label: "Search cost / 1K", type: "number" }, { key: "character_cost_per_1m", label: "Character cost / 1M", type: "number" }, { key: "page_cost_per_1k", label: "Page cost / 1K", type: "number" }, { key: "audio_cost_per_minute", label: "Audio cost / minute", type: "number" }, { key: "video_cost_per_second", label: "Video cost / second", type: "number" }, { key: "image_cost_per_unit", label: "Image cost / unit", type: "number" }, { key: "currency", label: "Currency", defaultValue: "USD" }];
const tableColumns = [{ key: "model", label: "Model" }, { key: "provider", label: "Provider" }, { key: "capabilities", label: "Capabilities" }, { key: "input_cost_per_1m", label: "Input / 1M" }, { key: "output_cost_per_1m", label: "Output / 1M" }, { key: "training_cost_per_1m", label: "Training / 1M" }, { key: "search_cost_per_1k", label: "Search / 1K" }, { key: "character_cost_per_1m", label: "Characters / 1M" }, { key: "page_cost_per_1k", label: "Pages / 1K" }, { key: "audio_cost_per_minute", label: "Audio / minute" }, { key: "video_cost_per_second", label: "Video / second" }, { key: "image_cost_per_unit", label: "Image / unit" }, { key: "currency", label: "Currency" }, { key: "max_input_tokens", label: "Max input tokens" }, { key: "max_output_tokens", label: "Max output tokens" }];

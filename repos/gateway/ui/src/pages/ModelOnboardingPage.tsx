...
export function ModelOnboardingPage() {
  ...
  const canApply = canReview && selectedCandidates.every((candidate) =>
    candidate.capabilities.length > 0 && (selectedProviderType !== "azure-openai" ||

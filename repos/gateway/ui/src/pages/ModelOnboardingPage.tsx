...
export function ModelOnboardingPage() {
  ...
  const [newProvider, setNewProvider] = useState({ id: "", type: "openai-compatible", base_url: "", api_version: "", auth_type: "api_key" });

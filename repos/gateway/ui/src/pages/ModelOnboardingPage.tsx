...
export function ModelOnboardingPage() {
  ...
  async function ensureProviderAndCredential() {
    ...
    if (providerID === "__new") {
      const providerInput = newProvider.type === "azure-openai" || newProvider.type === "bedrock" ? newProvider : { id: newProvider.id, type: newProvider.type, base_url: newProvider.base_url };

...
type UsageAggregate = {
  ...
  total_tokens: number; input_characters: number; input_pages: number; cache_read_input_tokens: number; cache_write_input_tokens: number; search_requests: number; cost: number; avg_latency_ms: number; cache_hits: number; cost_per_request: number;
};
type UsageReport = {
...
const usageColumns = [
  ...
  { key: "output_tokens", label: "Output tokens" }, { key: "input_characters", label: "Input characters" }, { key: "input_pages", label: "Input pages" }, { key: "cache_read_input_tokens", label: "Cache read tokens" }, { key: "cache_write_input_tokens", label: "Cache write tokens" }, { key: "search_requests", label: "Searches" }, { key: "cache_hits", label: "Cache hits" }, { key: "latency", label: "Average latency" },

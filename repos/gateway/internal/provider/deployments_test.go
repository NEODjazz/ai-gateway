...
func TestManagedDeploymentAcceptsSupportedFeatureCapabilities(t *testing.T) {
	tests := []struct {
		...
		{providerType: "vertex-gemini", capabilities: []string{"chat", "embeddings", "stream", "gemini_safety_settings", "gemini_code_execution", "gemini_audio_timestamp", "url_context", "tools", "structured_output", "vision", "web_search", "audio_input", "video_input", "file_input"}},

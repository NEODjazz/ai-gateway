...
func TestManagedDeploymentAcceptsSupportedFeatureCapabilities(t *testing.T) {
	tests := []struct {
		...
		{providerType: "groq", capabilities: []string{"chat", "responses", "audio_transcription", "audio_speech", "stream", "tools", "structured_output", "mcp", "vision"}},
...
func TestManagedProviderCapabilityProfilesMatchAdapterOperations(t *testing.T) {
	...
	if !slices.Equal(profilesByType["groq"].Operations, []string{"chat", "responses", "audio_transcription", "audio_speech", "stream"}) || !slices.Equal(profilesByType["groq"].Capabilities, []string{"chat", "responses", "audio_transcription", "audio_speech", "stream", "tools", "structured_output", "mcp", "vision"}) {

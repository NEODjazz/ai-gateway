...
func TestManagedProviderCapabilityProfilesExposeValidatedChatParameters(t *testing.T) {
	...
	tests := map[string]ProviderChatParameterPolicy{
		...
		"groq":              {ReasoningEffort: allReasoning, ReasoningFormat: []string{"hidden", "raw", "parsed"}, Logprobs: []string{}, ServiceTier: []string{"auto", "on_demand", "flex", "performance"}},
...
func TestManagedProviderCapabilityProfilesExposeAllValidatedChatOptions(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"groq":              {"include_reasoning", "user", "reasoning_effort", "reasoning_format", "service_tier"},

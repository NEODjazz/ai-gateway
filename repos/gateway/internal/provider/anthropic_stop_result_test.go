...
func TestAnthropicMatchedStopIsPreservedInJSONAndStream(t *testing.T) {
	...
	result, err := streamAnthropicChat(strings.NewReader(stream), "model", false, nil, nil, func(payload string) error { payloads = append(payloads, payload); return nil })

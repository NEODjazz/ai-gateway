...
func TestRoutingDiagnosticsExposeSafeOperationalState(t *testing.T) {
	...
	endpoint := Endpoint{
		...
		Capabilities: []string{"chat", "stream"}, GuardrailPolicy: "strict", GuardrailPolicyValid: true, DLPEnabled: true, OutputDLPEnabled: true,
	...
	if got.State != "cooling_down" || got.CooldownUntil == nil || got.Samples != 1 || got.LatencyEWMAms != 20 || got.FailureEWMA != 1 || got.MaxParallelRequests != 2 || got.QueueCapacity != 3 || got.RateLimitRPM != 120 || got.RateLimitTPM != 64000 || got.ProviderRateLimitRPM != 500 || got.ProviderRateLimitTPM != 250000 || !got.DLPEnabled || !got.OutputDLPEnabled {

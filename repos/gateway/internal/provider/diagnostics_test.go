...
func TestRoutingDiagnosticsExposeSafeOperationalState(t *testing.T) {
	...
	if got.State != "cooling_down" || got.CooldownUntil == nil || got.Samples != 1 || got.LatencyEWMAms != 20 || got.FailureEWMA != 1 || got.MaxParallelRequests != 2 || got.QueueCapacity != 3 || !got.DLPEnabled {

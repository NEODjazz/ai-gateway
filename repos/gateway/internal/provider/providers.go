...
var managedFeatureCapabilities = []string{
	...
	"web_fetch", "audio", "prompt_cache", "assistant_prefill", "memory_tool", "bash_tool", "text_editor_tool", "computer_toolset", "browser_toolset", "thinking", "zero_output", "inference_geo", "context_management",

...
func validDeploymentCapabilities(capabilities []string) bool {
	allowed := map[string]bool{
		...
		"stream": true, "tools": true, "structured_output": true, "mcp": true, "vision": true, "web_search": true, "audio": true, "prompt_cache": true, "image_generation": true, "image_edit": true, "image_variation": true, "audio_transcription": true,
	}

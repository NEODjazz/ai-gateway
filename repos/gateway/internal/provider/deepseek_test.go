...
func TestDeepSeekResponsesRejectsIgnoredInputItemTypes(t *testing.T) {
	...
	for _, input := range []any{
		...
		[]any{map[string]any{"type": "message", "content": "missing role"}},
		[]any{map[string]any{"type": "message", "role": "tool", "content": "unsupported role"}},
		[]any{map[string]any{"type": "message", "role": "system", "content": []any{map[string]any{"type": "input_image", "image_url": "https://example.test/image.png"}}}},
		[]any{map[string]any{"type": "message", "role": "assistant", "content": []any{map[string]any{"type": "input_image", "image_url": "https://example.test/image.png"}}}},
...
func TestDeepSeekResponsesAcceptsDocumentedInputItemTypes(t *testing.T) {
	for _, item := range []map[string]any{
		...
		{"type": "message", "role": "developer", "content": []any{map[string]any{"type": "input_image", "image_url": "https://example.test/image.png"}}},

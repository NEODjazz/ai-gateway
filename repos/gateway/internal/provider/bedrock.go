...
func bedrockChatRequest(request openai.ChatCompletionRequest) (bedrockRequest, error) {
	...
	if err := rejectParameters("bedrock",
		...
		parameterCheck{"modalities", request.Modalities != nil}, parameterCheck{"clear_thinking", request.ClearThinking != nil}, parameterCheck{"reasoning_effort", request.ReasoningEffort != ""},

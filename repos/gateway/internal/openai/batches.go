...
func (r BatchCreateRequest) Validate() string {
	...
	switch r.Endpoint {
	case "/v1/responses", "/v1/responses/compact", "/v1/chat/completions", "/v1/embeddings", "/v1/completions", "/v1/moderations", "/v1/rerank", "/v1/search", "/v1/images/generations", "/v1/audio/speech":
	default:

...
var gatewayRoutes = []routeDefinition{
	...
	{RouteContract{http.MethodPost, "/v1beta/cachedContents"}, func(h Handler) http.Handler { return http.HandlerFunc(h.CreateCachedContent) }},
	{RouteContract{http.MethodGet, "/v1beta/cachedContents"}, func(h Handler) http.Handler { return http.HandlerFunc(h.ListCachedContents) }},
	{RouteContract{http.MethodGet, "/v1beta/cachedContents/{id}"}, func(h Handler) http.Handler { return http.HandlerFunc(h.GetCachedContent) }},
	{RouteContract{http.MethodPatch, "/v1beta/cachedContents/{id}"}, func(h Handler) http.Handler { return http.HandlerFunc(h.UpdateCachedContent) }},
	{RouteContract{http.MethodDelete, "/v1beta/cachedContents/{id}"}, func(h Handler) http.Handler { return http.HandlerFunc(h.DeleteCachedContent) }},

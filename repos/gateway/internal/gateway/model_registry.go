...
func (h Handler) PutModelCatalog(w http.ResponseWriter, r *http.Request) {
	...
	allowedCapabilities := map[string]bool{"chat": true, "responses": true, "embeddings": true, "rerank": true, "moderation": true, "image_generation": true, "image_edit": true, "image_variation": true, "stream": true, "tools": true, "structured_output": true, "mcp": true, "vision": true, "web_search": true, "audio": true, "prompt_cache": true, "assistant_prefill": true}
	for _, entry := range catalog.Models {

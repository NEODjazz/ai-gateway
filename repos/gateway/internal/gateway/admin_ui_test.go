...
func TestAdminUIServesEmbeddedSameOriginAssets(t *testing.T) {
	...
	for _, expected := range []string{"AI Gateway Console", "/ui/assets/app.css?v=14", "/ui/assets/app.js?v=14", "Admin bearer token", "Overview", "Usage &amp; spend", "Customer insights", "customer-filter-form", "customer-budgets-table", "customer-keys-table", "Request logs", "Virtual key", "request-log-credential", "Routing", "Playground", "Virtual keys", "Users", "Teams", "Organizations", "organizations-table", "organization-dialog", "organization-team-dialog", "AI Hub &amp; optimization", "ai-hub-table", "cost-recommendations-table", "Scoped RBAC", "users-table", "teams-table", "membership-dialog", "Models", "Providers &amp; models", "providers-table", "credentials-table", "deployments-table", "model-groups-table", "provider-dialog", "credential-dialog", "deployment-dialog", "model-group-dialog", "Write-only secrets", "Guardrails", "guardrails-table", "Compliance playground", "compliance-form", "guardrail-dialog", "MCP registry", "mcp-servers-table", "mcp-toolsets-table", "mcp-server-dialog", "mcp-toolset-dialog", "Budgets", "Audit log", "routing-cards", "playground-form", "usage-chart", "usage-models-table", "request-log-filter-form", "request-logs-table", "Content storage off", "Add catalog entry", "Create budget", "Create virtual key", "key-alias", "key-dialog", "issued-key-dialog", "model-dialog", "budget-dialog", "request-log-dialog", "confirm-dialog"} {

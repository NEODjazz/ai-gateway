...
func TestResponsesRejectsInvalidOptionsBeforeExecution(t *testing.T) {
	...
	handler := Handler{}
	for _, option := range []string{`"max_output_tokens":0`, `"max_output_tokens":-1`, `"max_tokens":0`, `"max_tokens":-1`, `"top_logprobs":-1`, `"top_logprobs":21`, `"truncation":""`, `"truncation":"unknown"`} {

...
| `bedrock` | Native Converse chat/tools; bearer mode for compatible private endpoints or AWS SigV4 with explicit credentials, environment keys, ECS/EKS container roles and EC2 IMDSv2 instance roles |

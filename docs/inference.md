...
| `xai` | Chat/stream and Responses with bearer authentication, model discovery, structured output, vision, web search, response compaction and owned retrieve/input-items/delete lifecycle; priority tier and bounded reasoning/logprobs validation |

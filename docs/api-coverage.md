...
| Response compaction | Native compact contract, bounded opaque output, model authorization, validated input and attachments, tool-history ACL, owner-checked resource references and usage settlement | Additional provider-native compact request options as demand is confirmed |

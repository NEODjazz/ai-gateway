...
| Assistants | Durable assistant definition create/list/get/update/delete with credential-and-user ownership, model/tool authorization, owned file/vector-resource validation, bounded schemas, atomic quotas, cursor pagination and optimistic updates | Thread, message, run, run-step and tool-output execution lifecycle |

...
| Rerank | Query/text-or-object documents, compatible adapter, native Cohere v2, Voyage and Together adapters; exact provider token usage with fail-closed Together accounting | Additional provider-specific request and usage matrices |

...
| Assistants | Durable assistant definition CRUD/list; thread CRUD with atomic initial messages; message CRUD/list with directional cursor pagination, multimodal content and owned attachments. Resources use credential-and-user ownership, bounded schemas, atomic quotas and optimistic updates | Run, run-step and tool-output execution lifecycle |

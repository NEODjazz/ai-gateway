...
| Realtime | Implemented for OpenAI-compatible deployments | Authenticated text-event WebSocket sessions, bounded lifecycle, per-response quotas and billing, optional buffered output scanning |
